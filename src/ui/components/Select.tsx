...
/*
 * Documentation:
 * Select — https://app.subframe.com/b5a91bfb9cba/library?component=Select_bb88f90b-8c43-4b73-9c2f-3558ce7838f3
 */
...
const Content = React.forwardRef<HTMLElement, ContentProps>(function Content(
  ...
  return children ? (
    <SubframeCore.Select.Content asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex w-full flex-col items-start overflow-hidden rounded-md border border-solid border-neutral-border bg-black px-1 py-1 shadow-lg z-50",
          className
        )}
        ref={ref as any}
      >
